       ...
       <div class="row">
           <div class="col-md-12">
            <div class="row d-flex justify-content-center my-4 py-2">
                <div class="col-sm-8  border border-warning btn btn-warning py-2 rounded-pill">
                    <button class="font-weight-light">Description: </button>
                </div>
            </div>
            <p class="font-weight-light" style="font-size: 2rem;color:black">{{$pro5->drugName}}</p><br><br>
            <div class="row">
                <div class="col-sm-9">
                    <p>{{$pro5->source}}</p>
                </div>
            ...
            <div class="row">
                <div class="col-sm-9 my-2">
                    <p>Drug Strength:{{$pro5->drugStrength}}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <h3>Quantity: {{$pro5->quantity}}</h3>
                </div>
                <div class="col-sm-4">
                    <h3>NDC: {{$pro5->ndc}}</h3>
                </div>
                <div class="col-sm-4">
                    <h3>Iot Number: {{$pro5->IotNumber}}</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <h3>Expire Time: {{$pro5->expireTime}}</h3>
                </div>
                <div class="col-sm-4">
                    <h3>Time: {{$pro5->selectTime}}</h3>
                </div>
                <div class="col-sm-4">
                    <h3>Date: {{$pro5->selectDate}}</h3>
                </div>
            </div>
            <div class="row d-flex justify-content-center my-4 py-2">
                <div class="col-sm-8  border border-warning btn btn-warning py-2 rounded-pill">
            ...
            <div class="row">
                <div class="col-sm-8">
                    <ul class="list-group">
                        <li class="list-group-item">Town: {{$pro5->town}}</li>
                        <li class="list-group-item">State: {{$pro5->state}}</li>
                        <li class="list-group-item">Post Code: {{$pro5->postCode}}</li>
                      </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-8">
                    <ul class="list-group">
                        <li class="list-group-item">Name: {{$pro5->firstName}} {{$pro5->lastName}}</li>
                        <li class="list-group-item">E-mail: {{$pro5->email}}</li>
                        <li class="list-group-item">Phone: {{$pro5->mobilePhone}}</li>
                      </ul>
                </div>
            </div>
            <div class="row d-flex justify-content-center my-4 py-2">
                <div class="col-sm-8  border border-warning btn btn-warning py-2 rounded-pill">
                    <a href="{{url('mediDonate')}}" class="font-weight-light text-white" >Back </a>
                </div>
            </div>
           </div>
       </div>
