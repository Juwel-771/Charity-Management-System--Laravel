...
<body>
                                    ...
                                    <li><a href="#">Donations<i class="ti-angle-down"></i></a>
                                        <ul class="submenu">
                                            ...
                                            <li><a class="dropdown-item" href="{{url('medicine')}}">Medicine
                                                    Donation</a></li>
                                            <li><a class="dropdown-item" href="{{url('gooding')}}">good
                                                    Donation</a></li>
    ...
    <div class="container my-4">
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="{{url('makeDonation')}}" class="btn btn-success">Back</a>
            </div>
        </div>
    </div>
    ...
    <div class=" row">
        <div class="col-md-8">
            ...
            <div class="card my-4">
                <h5 class="card-header">Goods Donation</h5>
                <div class="card-body">
                    <h5 class="card-title">{{$goods->goodsName}}</h5>
                    <p class="card-text">{{$goods->item}}</p>
                    <a type="button" href="{{url('goodsProfile',$goods->id)}}" class="btn btn-outline-success">Contact</a>
                </div>
            </div>
            @endforeach
        </div>
