    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12">
                        <img src="/storage/environment_images/{{$profile->file}}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8">
                        <h3 style="font-size: 5rem">{{$profile->ngoName}}</h3>
                        <h3>We Came Here: {{$profile->ESTD}}</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 my-2">
                        <h5 style="font-size: 25px">Email: {{$profile->email}}</h5>
                    </div>
                    <div class="col-md-4 my-2">
                        <a style="font-size: 25px" href="#">Website: {{$profile->website}}</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 my-2">
                        <p style="font-size: 20px">{{$profile->description}}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 my-2">
                        <p style="font-size: 20px">{{$profile->description_two}}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 my-2">
                        <p style="font-size: 20px">{{$profile->description_three}}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="/showEnviroment" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-2">
                <a href="{{url('animal')}}" class="btn btn-danger">Back</a>
            </div>
        </div>
    </div>
    </div>
