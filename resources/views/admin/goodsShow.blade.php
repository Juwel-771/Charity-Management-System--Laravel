            ...
            <table class="table table-light table-hover text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border-bottom-success">{{$goods->firstName}}</td>
                        <td class="border-bottom-success">{{$goods->lastName}}</td>
                        <td class="border-bottom-success">{{$goods->mobilePhone}}</td>
                        <td class="border-bottom-success">{{$goods->email}}</td>
                        <td class="border-bottom-success">
                            <a href="{{url('/edit_goods',$goods->id)}}" class="btn btn-success btn-sm">View</a>
                        </td>
                    </tr>     
                    @endforeach
                </tbody>
