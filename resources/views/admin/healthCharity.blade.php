        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div class="col-md-12">
                ...
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        @foreach ($heal as $health)
                        <tr>
                            <td class="border-bottom-dark">{{$health->ngoName}}</td>
                            <td class="border-bottom-dark">{{$health->ESTD}}</td>
                            <td class="border-bottom-dark">{{$health->email}}</td>
                            <td class="border-bottom-dark">{{$health->website}}</td>
                            <td class="border-bottom-dark">
                                <a href="{{url('/edit_health',$health->id)}}" class="btn btn-dark btn-sm">View</a>
                                <a href="{{url('/health_delete',$health->id)}}" class="btn btn-danger btn-sm">Remove</a>
                            </td>
                        </tr>     
                        @endforeach
                    </tbody>
