        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div class="col-md-12">
                ...
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        @foreach ($hmn as $human)
                        <tr>
                            <td class="border-bottom-dark">{{$human->ngoName}}</td>
                            <td class="border-bottom-dark">{{$human->ESTD}}</td>
                            <td class="border-bottom-dark">{{$human->email}}</td>
                            <td class="border-bottom-dark">{{$human->website}}</td>
                            <td class="border-bottom-dark">
                                <a href="{{url('/edit_human',$human->id)}}" class="btn btn-dark btn-sm">View</a>
                                <a href="{{url('/human_delete',$human->id)}}" class="btn btn-danger btn-sm">Remove</a>
                            </td>
                        </tr>     
                        @endforeach
                    </tbody>
