            ...
            <div class="col-md-12">
                ...
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="border-bottom-dark">{{$social->ngoName}}</td>
                            <td class="border-bottom-dark">{{$social->ESTD}}</td>
                            <td class="border-bottom-dark">{{$social->email}}</td>
                            <td class="border-bottom-dark">{{$social->website}}</td>
                            <td class="border-bottom-dark">
                                <a href="{{url('/edit_social',$social->id)}}" class="btn btn-dark btn-sm">View</a>
                                <a href="{{url('/social_delete',$social->id)}}" class="btn btn-danger btn-sm">Remove</a>
                            </td>
                        </tr>     
                        @endforeach
                    </tbody>
