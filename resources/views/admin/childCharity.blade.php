            ...
            <div class="col-md-12">
                ...
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="border-bottom-dark">{{$child->ngoName}}</td>
                            <td class="border-bottom-dark">{{$child->ESTD}}</td>
                            <td class="border-bottom-dark">{{$child->email}}</td>
                            <td class="border-bottom-dark">{{$child->website}}</td>
                            <td class="border-bottom-dark">
                                <a href="{{url('/edit_child',$child->id)}}" class="btn btn-dark btn-sm">View</a>
                                <a href="{{url('/child_delete',$child->id)}}" class="btn btn-danger btn-sm">Remove</a>
                            </td>
                        </tr>     
                        @endforeach
                    </tbody>
