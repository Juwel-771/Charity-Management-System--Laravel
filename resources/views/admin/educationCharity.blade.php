        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div class="col-md-12">
                ...
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        @foreach ($edu as $educaion)
                        <tr>
                            <td class="border-bottom-dark">{{$educaion->ngoNamee}}</td>
                            <td class="border-bottom-dark">{{$educaion->ESTDe}}</td>
                            <td class="border-bottom-dark">{{$educaion->emaile}}</td>
                            <td class="border-bottom-dark">{{$educaion->websitee}}</td>
                            <td class="border-bottom-dark">
                                <a href="{{url('/edit_education',$educaion->id)}}" class="btn btn-dark btn-sm">View</a>
                                <a href="{{url('/education_delete',$educaion->id)}}" class="btn btn-danger btn-sm">Remove</a>
                            </td>
                        </tr>     
                        @endforeach
                    </tbody>
