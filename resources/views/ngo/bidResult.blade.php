                            ...
                            <tbody>
                                @foreach ($result as $stu)
                                    <tr>
                                        ...
                                        <td>{{$stu->time_two}}</td>
                                        <td>
                                            <a href="{{url('/editAuc',$stu->id)}}" class="btn btn-info btn-sm">Publish Result</a>
                                            <a href="{{url('/destroyAuc',$stu->id)}}" class="btn btn-danger btn-sm">postponed</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
